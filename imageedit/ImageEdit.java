...
public class ImageEdit
{
    ...
    // Добавлено! Координаты треугольника
    ...
    public ImageEdit()
    {
        ...
        JToolBar toolbar = new  JToolBar("Toolbar", JToolBar.VERTICAL);
          ...
          // Добавлено! Кривая и треугольник
          JButton arcbutton = new  JButton();
          ...
          JButton triangbutton = new  JButton();
          triangbutton.addActionListener(new  ActionListener()
            {
              public void actionPerformed(ActionEvent event)
              { 
                rezhim=8;
                             ...
                             // линия
                              ...
                              case 7:
                                  ...
                                  if (yf > yPad)
                                      ...
                                      arcAngle = 180;
                                  if (y2 < y1)
                                    g.drawArc(x1, y1, x2-x1, y2-y1, 0, arcAngle);
                                  else 
                                    g.drawArc(x1, y1, x2-x1, y2-y1, 0, arcAngle);
                                  break;   
                              // треугольник
